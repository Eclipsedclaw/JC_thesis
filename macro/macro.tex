...
\usepackage[pdftex,
    ...
    breaklinks=true,
    colorlinks=true,
    linkcolor=blue,     % Keep this - sets default link color to blue
...
% Fix ONLY acronym links to be black (do this AFTER hyperref)
\makeatletter
\renewcommand*{\AC@hyperlink}[2]{%
  \begingroup
  \hypersetup{linkcolor=black}% Temporarily override to black for acronyms
  \hyperlink{#1}{#2}%
  \endgroup
}
\makeatother
