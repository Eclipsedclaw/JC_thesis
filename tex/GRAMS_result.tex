...
\end{tabularx}\\
\vspace{0.1cm} 
Sensitivity numerical values for potential satellite mission. Upgraded items marked in \textbf{bold}. Detailed expalainlation of each items refer to table.~\ref{table:Balloon_table}.
