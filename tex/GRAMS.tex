...
\begin{figure}
    ...
    The GRAMS antimatter detection technique. The stopped antimatter forms an excited exotic atom that decays and emits atomic X-rays and annihilation products(pions and protons). The atomic X-rays, pion/proton multiplicities, and the stopping depth in the LArTPC provide the particle identification capability.
...
\begin{figure}
    ...
    \textbf{(a)} eGRAMS mission trajectory. \textbf{(b)} eGRAMS mission altitude during operation. \textbf{(c)} eGRAMS chamber status during operation \cite{Nakajima:2024fgx}.
