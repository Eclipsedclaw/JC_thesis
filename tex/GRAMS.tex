...
For an incoming gamma ray, multiple Compton scatterings will be measured and used to reconstruct the Compton ring to determine the source direction. GRAMS has also developed algorithms to reconstruct the Compton event  inside our detector \cite{TAKASHIMA2022166897, YONEDA2023102765}.
