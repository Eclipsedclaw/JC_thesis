...
\begin{figure}
    ...
    \noindent\raggedright \ac{GAPS} balloon trajectory during the flight. In figure, blue trakectory shows the flight path from launch until first circle back to near McMurdo station. Red trajectory shows the second circle path before landing nearby McMurdo station.
