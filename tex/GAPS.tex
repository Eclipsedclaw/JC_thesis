...
Due to both \ac{GAPS} project timeline and the pandemic situation, the GFP thermal system was designed, fabricated, and tested before the flight system was assembled. Thermal system of \ac{GAPS} is highly integrated with detector system, makes it hard to prepare in parallel. Then the GFP thermal system is designed to validate the novel \ac{OHP} cooling technique for \ac{GAPS} Si(Li) tracker before the full payload is ready, see section.~\ref{chap:GAPS:thermal:OHP}. The GFP thermal system is designed to be as close as possible to the flight thermal system in order to provide a representative validation of the \ac{OHP} technique. This section discusses the design of the GFP thermal system. The concept of \ac{OHP} and \ac{MCHP} will be discussed in section.~\ref{chap:GAPS:thermal:OHP} while the performance of the GFP thermal system is presented in section.~\ref{chap:GAPSresult:GFP:thermal}.
