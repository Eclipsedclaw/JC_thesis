...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{fig/GFP_system_diagram.png}\\
    \caption{\ac{GFP} system diagram}
    \label{fig:GFP_system_diagram}
\end{figure}
...
Since the aim of the \ac{GFP} is to demonstrate a ground-based system with a simplified configuration. Fig.~\ref{fig:GFP_system_diagram} shows the system diagram of \ac{GFP} and Fig.~\ref{fig:GAPS_GFP_config} shows the GFP overall setup. Major components are listed below,
\begin{itemize}
