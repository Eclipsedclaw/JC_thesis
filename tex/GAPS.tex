...
\begin{figure}[H]
    ...
    \caption{Left figure shows \ac{GAPS} payload design while right figure shows the actual payload hanging from the flight vehicle at McMurdo Station}
...
\begin{figure}
    ...
    \noindent\raggedright Left photo shows NASA \ac{LDB} inflating in preparation for launch. The middle photo shows the moment when the \ac{GAPS} payload left the launch vehicle. The right photo shows the \ac{GAPS} payload ascending into the stratosphere against a clear sky.
...
\begin{figure}
    ...
    \caption{\ac{GFP} \ac{Si(Li)} detector electronics connection in the row configuration.}
