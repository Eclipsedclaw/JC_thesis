...
\begin{figure}
    ...
    \noindent\raggedleft Left photo shows NASA \ac{LDB} inflating in preparation for launch. The middle photo shows the moment when the \ac{GAPS} payload left the launch vehicle. The right photo shows the \ac{GAPS} payload ascending into the stratosphere against a clear sky.
