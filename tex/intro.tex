...
The existence of dark matter is supported by multiple astronomical observations including galaxy rotation curves, gravitational lensing in the Bullet Cluster \cite{10.1046/j.1365-8711.2000.03075.x} and galaxy-scale structure formation. Despite the observational evidence, the nature of dark matter and its interactions with ordinary matter remain poorly understood. The form of \ac{DM} has varies models from particle-like to wave-like, from axion-like to multi-component. This thesis focuses on the WIMP class, for which indirect searches via cosmic antinuclei provide a powerful approach.

Several theoretical frameworks attempt to explain dark matter, with Weakly Interacting Massive Particles (WIMPs) being one of the leading candidates. Proposed WIMP candidates include neutralinos, right-handed sneutrinos, and right-handed neutrinos in extra dimension theories \cite{donato2000antideuterons, donato2008antideuteron,cerdeno2009right, cerdeno2014low,baer2005low}. Astrophysics experiments to detect \ac{WIMP}-like dark matter, both directly and indirectly, are ongoing, including satellite missions like the Alpha Magnetic Spectrometer-02 (AMS-02) and the Fermi Gamma-ray Space Telescope (Fermi), as well as balloon-borne experiments such as the Balloon-borne Experiment with a Superconducting Spectrometer (BESS) and the General Antiparticle Spectrometer (GAPS) \cite{aguilar2002alpha, lubelsmeyer2011upgrade, ajima2000superconducting, hailey2006accelerator}. For \ac{WIMP} \ac{DM}, the detection approaches are broadly categorized into the experiments interact with the primary \ac{DM} candidates, \ac{DM} searches in laboratory, direct \ac{DM} searches, and indirect \ac{DM} searches. The concept is quite straightforward, \ac{DM} searches in laboratory expect beams interacting in the accelerators could generate \ac{DM} as daughters, to effectively collect all daughters to determine the missing flux as potential \ac{DM} channel. Direct \ac{DM} searches expect \ac{DM} particles directly interact with their special detectors to capture the extremely rare signals, like Panda, CDMS. While indirect \ac{DM} searches target on abnormal peaks on top of the standard model particles, assuming \ac{WIMP} \ac{DM} will also interact with background and produce anomalous fluxes inconsistent with purely secondary production.

\section{Indirect Dark Matter Searches}
\label{chap:intro:IDMS}

Like the introduction section mentioned, indirect dark matter searches measure the particles from the dark matter annihilation or decay, providing an effective method to test various dark matter models from a different perspective. In particular, indirect dark matter searches with antideuterons or antiheliums have been instrumental in broadening our understanding of the field because their secondary astrophysical backgrounds are suppressed by orders of magnitude relative to DM-induced signals in the sub-GeV/n range. Dark matter interaction induced cosmic-ray (CRs) antideuterons and antiheliums fluxes predicted by many different models exceed the estimated astrophysical background in the energy range of GeV/n or sub-GeV/n by orders of magnitude, see Fig.~\ref{fig:cosmic_flux} \cite{PhysRevD.102.063004, Doetinchem_2020, PhysRevD.62.043003, Baer_2005, PhysRevD.78.043506, PhysRevD.71.083013, Alejandro_Ibarra_2013,PhysRevD.88.023014, N.Fornengo_2013, PhysRevD.89.103504, PhysRevD.97.103011, Tomassetti:2017DQ, lin2018expectationscosmicantideuteronflux, Ding_2019, 10.1007/jhep082014009, PhysRevD.89.076005, PhysRevD.96.083020}. In our matter-dominated Universe, astrophysical production of antimatter is dominated by pair production from the collision of \ac{CRs} with \ac{ISM} particles, with protons being the largest component of both the \ac{CRs} and \ac{ISM} (in the form of hydrogen gas). Antinuclei can be formed in collisions with energy above their respective production thresholds. This threshold for light antinuclei increases steeply with antinucleon number because every additional antinucleon requires the production of a corresponding nucleon as well. The energy thresholds for \ac{ad}, \ac{aHe3}, and \ac{aHe4} in p-p interactions are about 17, 31, and 49 GeV, respectively, in the target frame or about 5.7, 7.5, and 9.7 GeV, respectively, in the center-of-mass frame. Through \ac{WIMP} type dark matter particel self-interactions, various Standard Model particles are expected to be generated. 

% TODO: checkout Dr. Donato's paper more detail and update this session
In most cases of the standard model particle cosmic rays like proton, electron or antiproton, their flux from \ac{DM} interaction channels is expected to be buried in the cosmic background, whereas antideuteron and antihelium-3 fluxes remain distinct due to the natural difficulty of their formation from charged cosmic rays (CRs) interactions, which \ac{CRs} propagation is described by the Fokker-Planck equation. The Fokker-Planck equation can be written as:
...
Here, $\gamma_i$ is the Lorentz factor for particle $i$, accounting for relativistic effects in the yield calculation. The analytical coalescence model assumes that antiprotons and antineutrons are produced independently (uncorrelated production) and that their momentum distributions are isotropic. These simplifications make the model tractable but may not fully capture the underlying physics. While $p_i$ and $dN_i/dp_i$ are, respectively, the momentum and the differential yield per event of particle i (\ac{ad}= antideuteron, \ac{ap} = antiproton, \textbf{$\bar{n}$} = antineutron). This is known as the analytical coalescence model and it does not take into account effects like energy conservation, spin alignment etc., which have an important effect on deuteron and antideuteron formation. It also assumes that the production of antiprotons and antineutrons is uncorrelated \cite{CHARDONNET1997313} and expresses the momentum distribution of the coalesced particle as the product of two independent isotropic distributions. This is another simplification since correlations have an important effect on the coalescence process \cite{PhysRevD.88.023014, Alejandro_Ibarra_2013, KADASTIK2010248}. These implications lead us to the experiment like \ac{GAPS} and \ac{GRAMS} which are designed to measure the low energy antideuteron flux with high sensitivity, providing crucial data to test and refine these theoretical models, and ultimately to search for potential dark matter signatures in the cosmic-ray antideuteron spectrum.

\begin{figure}
\begin{center} 
\includegraphics*[width=1\linewidth]{fig/GRAMS_antideuteron.png}
\end{center}
\caption[The Antideuteron flux and sensitivity]{The Antideuteron flux and sensitivity. The antideuteron flux in the $sub-GeV/n$ region exhibits a high signal-to-noise ratio \cite{aramaki2020dual}.}
\label{fig:antideuteron_sensitivity}

\end{figure}

% refine this section with more details
\subsection{Indirect Dark Matter searches with antihelium}
\label{chap:intro:IDMS:antihelium}
Similar to using antideuteron as smoking gun detecting \ac{DM} generated standard model particles, using antihelium to perform indirect dark matter searches are receiving increasing attention following the reported candidate cosmic antihelium events from AMS-02~\cite{aguilar2013first}. These observations are particularly intriguing as they may indicate antihelium production through dark matter annihilation processes since standard astrophysical production of antihelium nuclei via cosmic interactions is highly suppressed, see Fig.~\ref{fig:antihelium3_sensitivity} \cite{PhysRevD.99.023016, PhysRevD.102.063004, Kachelrie_2020}.

ALICE collaboration also reported the potential inelastic cross section of antihelium-3 from \ac{LHC} \cite{Serksnyte}.

% TODO: refine this section with more details
\section{Cosmic-ray antiprotons}
\label{chap:intro:antirpotons}
Cosmic antiprotons have been measured from AMS and BESS experiment, leave open questions about the origin and the mechanism of its flux \cite{PhysRevLett.117.091103, YAMAMOTO2013227, sakai2021new}. Antiproton flux is the largest components of all the cosmic antinucleus, which could be generated by energetic cosmic protons interacting with \ac{ISM} \cite{Moskalenko_2002, kiraly1981antiprotons}.
...
Why balloon experiments? As a multi-decade scientific program, scientific ballooning offers a transformative platform for conducting cutting-edge observations at the stratosphere. By deploying specific payloads to the stratosphere at altitudes exceeding 30 kilometers, balloon experiments could cross the cosmic-ray shower altitude to measure the primary cosmic rays with reduced backgrounds, while at the same time avoiding astronomical costs and risks associated with satellite missions. Balloon experiments also have the advantage of short term technology innovation cycles, which allows for rapid iteration and testing of new technologies in a relevant environment. This is particularly important for the development of novel detection techniques for indirect dark matter searches, where the ability to quickly test and refine new ideas can significantly accelerate progress in the field. Additionally, balloon experiments can provide valuable data that can be used to inform the design of future satellite missions, helping to ensure that these missions are optimized for their scientific goals. Overall, balloon experiments play a crucial role in advancing our understanding of the universe and have the potential to make significant contributions to the field of astrophysics and cosmology.

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{fig/suborbital_figure2.jpg}
    \caption[Typical development paths for suborbital experiments and technologies\cite{nasa_suborbital}]{Typical development paths for suborbital experiments and technologies. \cite{nasa_suborbital}}
    \label{fig:suborbital_balloon}
\end{figure}

Particularly for Balloon-Borne Indirect Dark Matter Search Experiments that this thesis focused on developing, the advantages are mainly low cost and reduced CR-induced shower backgrounds at stratospheric altitudes \cite{grieder2010extensive, PhysRev.76.1092}. To apply our charge particle detection technique and identify antinucleons, we must detect as many primary cosmic-ray particles as possible while minimizing shower-induced backgrounds. Additionally, balloon-borne experiments are cost-effective, allowing extensive laboratory research and development to prepare for future satellite missions that will achieve unprecedented sensitivity for \ac{CRs} measurements in the relevant energy range. With more than 25km altitude, \ac{CRs} shower backgrounds are significantly reduced. Based on this we could choose a variety of balloon types to fulfill our request, see Fig.~\ref{fig:balloon_altitude}. Once selected balloon type, payload floating altitude will be related to the total suspended weight. The heavier the payload becomes, the lower the leveling flight altitude will be. For \ac{GAPS} experiment science flight, the Zero-Pressure Balloon: Long Duration Antarctic is chosen, detailed information see relative column in Chart.~\ref{table:NASA_Balloon}. As for \ac{GRAMS} experiment, particularly pGRAMS mission selected NASA-Contracted Commercial Flight Providers worldview, which has flight duration several hours to several days at a floating target altitude 15-30 km \cite{worldviewspace2025}. The nominal payload weight capacity could reach to 500 kg, which is also pGRAMS's design target.

To this end, suborbital flight testing can serve as an invaluable opportunity for conducting advanced scientific investigations as well as maturing novel technologies comparing to underground experiment and satellite experiment, see Fig.~\ref{fig:suborbital_balloon} \cite{nasa_suborbital}. 

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{fig/NASA_standards_metric.jpg}
    \caption[NASA Standard Design Balloon Load/Altitude Curves (Metric units) \cite{nasa_suborbital}]{NASA Standard Design Balloon Load/Altitude Curves (Metric units) \cite{nasa_suborbital}. Once selected balloon type, payload floating altitude will be related to the total suspended weight. The heavier the payload accumulate, the lower the leveling flight altitude will be.}
...
\begin{tabularx}{\linewidth}{>{\raggedleft\arraybackslash}p{2.2cm} X X X X}
\toprule
\textbf{Category} & 
...
\begin{figure}
    ...
    \noindent\raggedright
    \caption[GAPS payload and detection concept]{GAPS payload and detection concept. The left picture shows \ac{GAPS} payload at McMurdo Station. The right figure shows the \ac{GAPS} detection concept.}
    \label{fig:GAPS_payload}
\end{figure}
GAPS (General AntiParticle Spectrometer) is an Antarctic balloon mission designed to search for low-energy ($< 0.25 GeV/n$) cosmic-ray antinuclei which has launched its first science payload in the austral summer of 2025, see Fig.~\ref{fig:GAPS_payload}.
GAPS is designed to precisely measure the flux of low-energy cosmic-ray antideuterons, antiprotons, and antihelium. To date, there has not been an unambiguous observation of cosmic-ray antideuterons or antihelium. Detection of even a single antideuteron by \ac{GAPS} would provide strong evidence for particle dark matter.
...
\begin{figure}
    ...
    \caption[pGAPS launch site at Taiki, Japan]{pGAPS launch site at Taiki, Japan.}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{fig/MeV_gap.png}
    \caption[\ac{GRAMS} MeV science goals]{\ac{GRAMS} MeV science goals. The continuum gamma-ray sensitivities at a $3\sigma$ confidence level for the GRAMS balloon experiment (one LDB flight, $T_{\text{eff}} = 35$ days) and a possible satellite mission with detector upgrades ($T_{\text{eff}} = 1$ year) compared to the sensitivities for previous and future experiments, including SPI (SPectrometer for INTEGRAL), PICsIT (PIxelated CsI Telescope) and ISGRI (INTEGRAL Soft Gamma-Ray Imager) on INTEGRAL. Black dashed lines represent the flux levels of 1--100 mCrab \cite{DeAngelis_2017, TAKAHASHI2013142}.}
    \label{fig:GRAMS_MeV_science}
\end{figure}

In the future, \ac{GRAMS} plan to perform science balloon flight and progress to a satellite mission to deliver the science results we proposed and simulated. Aside from the antinuclei detection as indirect \ac{DM} searches that was mentioned earlier, \ac{GRAMS} proposed detector is also capable of detecting MeV gamma ray. In recent astrophysical observations, the Large Area Telescope on the Fermi Gamma-ray Space Telescope (Fermi-LAT) and the Nuclear Spectroscopic Telescope Array (NuSTAR) have deeply explored astrophysical phenomena in the energy domains for hard X-rays (up to 80 keV) and high-energy gamma rays (above 20 MeV), respectively \cite{Atwood_2009, Harrison_2013}. However, gamma rays in the MeV energy range have not yet been well-explored (the so-called “MeV gap”). COMPTEL (The Imaging COMPton TELescope) produced the first catalog of MeV sources, but only approximately 30 objects have been detected \cite{refId0}. MeV gamma-ray astronomy is essential for studying nucleosynthesis, particle acceleration, and violent cosmic events involving black holes and neutron stars. It also plays a key role in multi-messenger astronomy, such as by detecting gamma rays associated with neutron star mergers and gravitational waves.

There are several key questions in MeV gamma-ray astronomy that \ac{GRAMS} will address:

\noindent\textbf{What is the population of MeV-emitting astrophysical objects?} There are many sources which potentially emit photons in the MeV gamma-ray domain (e.g., active galactic nuclei, X-ray and gamma-ray binaries, pulsars/pulsar wind nebula, supernova remnants). These objects in principle have nonthermal (continuum) emission in a broad energy band, ranging from radio to GeV gamma ray and above. Measurements of the nonthermal emission allow us to understand the mechanism of particle acceleration at different scales of shocks and jets in the aforementioned sources. $\sim$2000 and $\sim$7000 sources have been already identified in the hard X-ray and GeV gamma-ray bands, respectively, by missions with sensitive instruments such as NuSTAR, INTEGRAL, Swift, and Fermi. Thus, some of them could be potential MeV gamma-ray emitters.
